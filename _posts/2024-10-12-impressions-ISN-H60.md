...
![](/assets/images/ISN-H60/ISN_H60_7.png)
![](/assets/images/ISN-H60/ISN_H60_8.png)
![](/assets/images/ISN-H60/ISN_H60_9.png)
...
![](/assets/images/ISN-H60/ISN_H60_1.png)

The tonal balance of H60 can be described as neutral warm with boosted bass. It means when I listen to an entire audio mix at the same time, such as [Dreamlang Express by John Denver](https://youtu.be/6pqfoBUTFdk?si=XuUt30bYzDEysn_6), I found bass guitar to be more prominent (boosted bass) without overwhelming the rest of the mix. The midrange elements such as the voice of John Denver, background singers, and the guitars are prominent without overpowering the rest of the mix. In the same vein, the treble instruments such as cymbals and hats in [Playing God by Polyphia](https://youtu.be/Z5NoQg8LdDk?si=NlVOrDpXzqA6pO_w) do not overpower the mix yet, at the same time, does not sacrifice their energy and volume in the mix. H60 also handles sibilant tracks such as [Shivers by Ed Sheeran](https://youtu.be/Il0S8BoucSA?si=rWyIVFrqevnieBQh) as expected. It does not make the track worse, but it does not tame the harshness of this track too much.
...
![](/assets/images/ISN-H60/ISN_H60_2.png)

The treble of H60 is where it slightly slips. On the plus side, the tonality of higher pitched instruments do not raise any immediate alert. For example, the hand claps section at the beginning of [Synchro BOM-BA-YE by Tokyo Kosei Wind Orchestra](https://youtu.be/4lwPiXnOGZ4?si=yxH6nkmatdeMAaUD), a section where any imbalance in the treble would stand out immediately, was produced without any significant problem by H60. However, closer inspection of the upper midrange and treble of H60 reveals some cracks. Firstly, the brass instruments lack the brilliance and "shine" that I expected. This problem could be due to the more subdued upper midrange of H60.

![](/assets/images/ISN-H60/ISN_H60_3.png)
...
![](/assets/images/ISN-H60/ISN_H60_6.png)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/-xKM3mGt2pE?si=58Rd0C5Hetorf9U-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
